...
// Get all users
router.get(PATHS.ALL_USERS, (_, res, next) => {
    UserModel.find()
...
// Edit user
router.put(PATHS.EDIT_ACCOUNT(), (req, res, next) => {
...
// Edit password
router.put(PATHS.EDIT_PASSWORD(), (req, res, next) => {
...
// Delete user
router.delete(PATHS.DELETE_ACCOUNT(), (req, res, next) => {
